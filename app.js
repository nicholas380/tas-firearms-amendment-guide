...
function openGuide(id){
  ...
  <div class="modal-content">
    ...
    <section class="guide-block"><h3>Official proposal</h3><p>${esc(a.official)}</p></section>
    <section class="guide-block side-by-side">
      <div><h3>Current position</h3><p>${esc(a.current)}</p></div>
      <div><h3>What would change</h3><p>${esc(a.change)}</p></div>
    </section>
